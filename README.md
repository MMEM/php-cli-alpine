...
Creating a new build with tag '8' without multi-arch support:
    ...
    $ docker build -t php-cli-alpine:8-doc -f ./Dockerfile .
...
Creating a new build with tag '8' **with** multi-arch support:
    ...
    $ docker buildx build --platform linux/arm64,linux/amd64 -t metalmanufactures/php-cli-alpine:8-doc -f ./Dockerfile .
